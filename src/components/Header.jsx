    ...
    return (
        <HStack padding={'.8rem 1rem'} justifyContent={'space-between'} bgColor={'#18181C'}>
            <HStack w={'60%'} justifyContent={'space-between'} >
                <Image src={Logo} userSelect={'none'} cursor={'pointer'} width={'6rem'} borderRadius={'5px'} />
            ...
            <HStack w={'25%'} justifyContent={'space-between'}>
                <Text display={'flex'} alignItems={'center'} gap={'.7rem'} padding={'.4rem 1rem'} cursor={'pointer'} transition={'.2s all ease'} _hover={{color : "teal"}}>Games Catalog <MdOutlineKeyboardArrowDown fontSize={'1.3rem'} /></Text>
