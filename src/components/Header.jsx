...
const Header = () => {
    ...
    return (
        <HStack  H={['7vh','10vh']} position={'sticky'} zIndex={'99'} top={'0'} padding={['.7rem 1rem','.6rem 2rem']} w={'100vw'} backdropFilter="blur(2px)"justifyContent={'space-between'} bgColor="rgba(10, 10, 10, 0.1)">
